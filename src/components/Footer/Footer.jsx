...
import { getSiteImages, getContactInfo, getAssetUrl, handleImageFallback } from '../../services/atapStorage'
import './Footer.css'
...
export default function Footer() {
  ...
  const waDigits = (contactInfo?.whatsapp?.linkDigits || contactInfo?.whatsapp?.number || '51977884423').replace(/\D/g, '')
  const waNumber = contactInfo?.whatsapp?.number || '+51 977 884 423'
  const email = contactInfo?.email?.email || 'contacto@atap.pe'
      ...
      <div className="footer-inner">
        ...
        <div className="footer-contact-actions">
          <a
            ...
            className="footer-contact-badge wa-badge"
            title={`Abrir WhatsApp oficial (${waNumber})`}
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="footer-contact-badge mail-badge"
        ...
        <div className="footer-social-icons">
          <a
            ...
            title="Instagram @atap_tenisperu"
          >
